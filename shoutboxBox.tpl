...
$this->user->getPermission('user.shoutbox.bbcode.font')} <select
	...
	<option value="times new roman" style="font-family: Times New Roman;">Times
	New Roman</option>
...
{if $this->user->getPermission('user.shoutbox.bbcode.i')} 
	<img src="wcf/icon/wysiwyg/fontStyleItalicM.png"
			onclick="shoutbox.insertBBCode('[i]','[\/i]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.u')} 
	<img src="wcf/icon/wysiwyg/fontStyleUnderlineM.png"
			onclick="shoutbox.insertBBCode('[u]','[\/u]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.s')} 
	<img src="wcf/icon/wysiwyg/fontStyleStriketroughM.png"
			onclick="shoutbox.insertBBCode('[s]','[\/s]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.img')} 
	<img src="wcf/icon/wysiwyg/insertImageM.png"
			onclick="shoutbox.insertBBCode ('[img]','[\/img]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.center')} 
	<img src="wcf/icon/wysiwyg/textJustifyM.png"
			onclick="shoutbox.insertBBCode('[align=center]','[\/align]');" 
			alt="" />
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.align')} 
	<img src="wcf/icon/wysiwyg/textAlignRightM.png"
...
{if $this->user->getPermission('user.shoutbox.bbcode.font')} 
	<select name="font" 
		...
		<option value="courier" style="font-family: Courier;">Courier</option>
		<option value="courier new" style="font-family: Courier New;">CourierNew</option>
		<option value="tahoma" style="font-family: Tahoma;">Tahoma</option>
...
{if $this->user->getPermission('user.shoutbox.bbcode.quote')} 
	<img src="wcf/icon/wysiwyg/quoteM.png"
			onclick="shoutbox.insertBBCode('[quote]','[\/quote]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.code')} 
	<img src="wcf/icon/wysiwyg/insertCodeM.png"
			onclick="shoutbox.insertBBCode('[code]','[\/code]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.css')} 
	<img src="wcf/icon/wysiwyg/insertCssM.png"
			onclick="shoutbox.insertBBCode('[css]','[\/css]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.html')} 
	<img src="wcf/icon/wysiwyg/insertHtmlM.png"
			onclick="shoutbox.insertBBCode('[html]','[\/html]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.java')} 
	<img src="wcf/icon/wysiwyg/insertJavaM.png"
			onclick="shoutbox.insertBBCode('[java]','[\/java]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.js')} 
	<img src="wcf/icon/wysiwyg/insertJavaScriptM.png"
			onclick="shoutbox.insertBBCode('[js]','[\/js]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.php')} 
	<img src="wcf/icon/wysiwyg/insertPhpM.png"
			onclick="shoutbox.insertBBCode('[php]','[\/php]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.bbcode.mysql')} 
	<img src="wcf/icon/wysiwyg/insertMysqlM.png"
			onclick="shoutbox.insertBBCode('[mysql]','[\/mysql]');" 
			alt="" /> 
{/if} 
{if $this->user->getPermission('user.shoutbox.c.java')} 
	<img src="wcf/icon/wysiwyg/insertCM.png"
			onclick="shoutbox.insertBBCode('[c]','[\/c]');" 
			alt="" /> {/if}</div>
{/if} 

</div>
>>>>>>> df94c18c1541eed4fbe3d433deb97ba2f322e830
</div>
</div>
